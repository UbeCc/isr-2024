...
if __name__ == '__main__':
   ...
   # number of training episodes
    ...
    # load data
    train_dataloader, val_dataloader, stats = load_data(data_dir, train_cfg['batch_size_train'], train_cfg['batch_size_val'])
    # save stats
    ...
    # train
    # transform policy_config to class
    class PolicyConfig:
